...
> chiechie:
> 
> 似乎能get到领导的意思，产品的目标是设计一个对的代表实践的方案，目的不是设计一个折中的方案，
> 如果没有拓扑数据，最好是去补充拓扑数据，
> 也可以做使用现在的纯data-driven的方式得到的流量关联图， 得到一个不可信但是可见的东西，
> 这个就是个玩意子，短期来说，吸引人眼球，长期来说，这个东西注定要被更好的方案代替

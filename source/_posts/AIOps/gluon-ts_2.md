...
- 原始的TS序列变成1个past_target 还是多个 past_target ？
    - 从节省样本的角度应该是多个
    - 测试的时候确实只用了最新的窗口，但是训练的时候不是，详细见下面训练过程的日志：
    - 根据信息-测试用例1
...
构造一个estimator，须实现3个方法：create_transformation/create_training_network/create_predictor
...
## 参考
1. [ujson dumps NaN but doesn't load it ](https://github.com/micropython/micropython/issues/3511)